...
SOCIAL_AUTH_VK_OAUTH2_API_VERSION = '5.92'
...
# SOCIAL_AUTH_INSTAGRAM_OAUTH2_KEY = os.getenv('SOCIAL_AUTH_INSTAGRAM_OAUTH2_KEY')
# SOCIAL_AUTH_INSTAGRAM_OAUTH2_SECRET = os.getenv('SOCIAL_AUTH_INSTAGRAM_OAUTH2_SECRET')
